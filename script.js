...
const translations = {
  ko: {
    ...
    modal_notice: '영상 설명란에 <strong>Claude 전용 Skill 파일 다운로드 링크</strong>가 포함되어 있습니다. 아래 방법으로 Claude에 추가하면 바로 사용할 수 있습니다.',
    modal_skill_title: 'Claude에 Skill 추가하는 법',
    modal_skill_1: '영상 설명란에서 Skill 파일(<code>.md</code>) 다운로드',
  ...
  en: {
    ...
    modal_notice: 'The video description contains a <strong>Claude Skill file download link</strong>. Follow the steps below to add it to Claude.',
    modal_skill_title: 'How to Add a Skill to Claude',
    modal_skill_1: 'Download the Skill file (<code>.md</code>) from the video description',
